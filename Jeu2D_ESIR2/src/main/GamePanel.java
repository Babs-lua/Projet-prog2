...
public class GamePanel extends JPanel implements Runnable {
	...
	// Création des différentes instances (Player, KeyHandler, TileManager,
	// GameThread ...)
	KeyHandler m_keyH;
	Thread m_gameThread;
	Player m_player;
	...
	public void run() {
		...
		while (m_gameThread != null) { // Tant que le thread du jeu est actif
			...
			// Dessine sur l'écran le personnage et la map avec les nouvelles informations.
			// la méthode "paintComponent" doit obligatoirement être appelée avec
			// "repaint()"
			this.repaint();
